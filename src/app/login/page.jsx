...
export default function loginPage() {
    ...
    return (
        <>
            <div className="min-h-screen flex flex-col max-w-md mx-auto bg-gelap opacity-100 font-poppins px-4 bg-no-repeat bg-cover bg-center bg-login-image">
                    ...
                    <div className="flex flex-col w-full space-y-1">
                        ...
                        <div className="w-full flex h-10 rounded border-2 border-yellow-300 bg-abu-5">
                            ...
                            <div className="w-10/12 rounded-r-xl">
                                <input type="text" className="w-full h-full rounded-r flex items-center px-1 focus:outline-none" placeholder="example@email.com"/>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col w-full space-y-1">
                        ...
                        <div className="w-full flex h-10 rounded border-2 border-yellow-300 bg-abu-5">
                            ...
                            <div className="w-10/12 rounded-r-xl">
                                <input type="text" className="w-full h-full rounded-r flex items-center px-1 focus:outline-none" placeholder="**********"/>
                            </div>
                        </div>
                    </div>
                    <div className="pt-6 w-full flex space-x-2 justify-between">
                        <button onClick={onLogin} className="h-10 w-5/12 border-2 border-orange-700 rounded-lg text-white font-semibold">Login</button>
                        <Link href="register" className="h-10 w-5/12 bg-btn rounded-lg text-white text-center items-center py-2 font-semibold">Register</Link>
                    </div>
                </div>
            </div>
        </>
